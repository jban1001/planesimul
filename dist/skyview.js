...
(function (global) {
  ...
  const FRAGMENT_SHADER = [
    ...
    '  float beyond = max(max(-along, along - uRunwayLength), 0.0);',
    '  float lateral = max(ax - halfWidth, 0.0);',
    '  float footprint = (1.0 - smoothstep(400.0, 1500.0, beyond))',
    ...
    '    * (1.0 - smoothstep(300.0, 700.0, beyond));',
    ...
    '    * (1.0 - smoothstep(500.0, 1100.0, beyond));',
    '',
    '  vec3 col = grass;',
    ...
    '    * (1.0 - smoothstep(600.0, 1200.0, beyond));',
  ...
  function create(canvas) {
    ...
    const state = {
      ...
      runwayZ0: 0, runwayLength: 3500, runwayWidth: 60, runwayLit: 1
    };
